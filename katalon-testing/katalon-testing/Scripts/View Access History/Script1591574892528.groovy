...
WebUI.click(findTestObject('Page_Account Settings/button_Security'))

WebUI.click(findTestObject('Page_Account Settings/span_View Access History'))

WebUI.verifyElementPresent(findTestObject('Page_Account Settings/div_CloseAccess HistoryTimestampActionIP Ad_0c9a68'), 
    0)
